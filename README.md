...
| Group  | Name        | | Comment               |
|--------|-------------|------------------------|------------------------|
| 1     | World Of Nazi | Menu(/) Story(X) Music(/) Level(X)| เกมแนวสู้กับนาซี เลือกตัวละครได้แล้ว 1 ตัว <br> แต่ยังมีปัญหาการแสดงท่ายิง เนื้อเรื่องน่าสนใจ แต่ยังไม่มีฉากในเกมส์ ตัวละครออกแบบได้ดี |
...
- https://github.com/Roake/G-2560-1
